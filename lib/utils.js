...
function nodes_equivalent(node1, node2){
    ...
    */
    ...
    if (node1.range !== undefined && node1.range !== null){
        ...
        // no range property? we'll check for a 'loc' one
        if (node1.loc !== undefined && node1.loc !== null){
            var start1 = node1.loc.start;
            var start2 = node2.loc.start;
            var end1 = node1.loc.end;
            var end2 = node2.loc.end;
            if (start1.line === start2.line && start1.column === start2.column){
                if (end1.line === end2.line && end1.column === end2.column){
                    return true;
                }
            }
        }
